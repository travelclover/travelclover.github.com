...
/******/ 	__webpack_require__.p = "file:///E:/mywork/project/travelclover/dist/";
/******/
/******/
...
/***/ "./src/controller/dailySentence.js":
/*!*****************************************!*\
  !*** ./src/controller/dailySentence.js ***!
  \*****************************************/
/*! no static exports found */
...
function getData() {
  return new Promise(function (resolve, reject) {
    _axios2.default.get('https://api.gushi.ci/all').then(function (data) {
      resolve(data.data);
    }).catch(function (err) {
      reject(err);
    });
